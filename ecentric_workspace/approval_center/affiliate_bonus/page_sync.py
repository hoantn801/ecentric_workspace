...
def _html():
    ...
    with open(os.path.join(base, "frontend", "affiliate_bonus.main_section.html"), encoding="utf-8") as fh:
        return fh.read()
...
BASELINE_SHA256 = "8839840bf294fb107a1f5b95c3982e4da501ba4d3acb6cda866c81f8c52bea67"
SUPERSEDES_SHA256 = ()
