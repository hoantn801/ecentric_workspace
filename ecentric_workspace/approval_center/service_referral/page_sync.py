...
def _html():
    ...
    with open(os.path.join(base, "service_referral", "ui", "main_section.html"), encoding="utf-8") as fh:
        return fh.read()
...
BASELINE_SHA256 = "fdac82e1793cbf9c95642aaa4f0995a1a8ffb813716e1c8a99156beab89a5df0"
SUPERSEDES_SHA256 = ("c582bf68fd676342bb597d347397bacfc4a1944ba302c32ebcdc598193daaee3",)
