...
def _html():
    ...
    with open(os.path.join(base, "frontend", "late_early_out.main_section.html"), encoding="utf-8") as fh:
        return fh.read()
...
BASELINE_SHA256 = "a33b607dcac5324e9a2060dc1ac2048e18260b607ec65e585afdb2c2657f083d"
SUPERSEDES_SHA256 = ()
