...
def _html():
    ...
    with open(os.path.join(base, "compensation_leave", "ui", "main_section.html"), encoding="utf-8") as fh:
        return fh.read()
...
BASELINE_SHA256 = "e7a4ba0d4fe56d5e01c1e5dbb1e872239350aad3b207777e99a206517a0fe485"
SUPERSEDES_SHA256 = ()
