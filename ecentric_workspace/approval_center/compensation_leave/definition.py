...
def _title(doc):
    from ecentric_workspace.approval_center.compensation_leave.service import gen_title
    return gen_title(doc)


def _submit(name):
    from ecentric_workspace.approval_center.compensation_leave.service import submit
    return submit(name)


def _resubmit(name, actor=None):
    from ecentric_workspace.approval_center.compensation_leave.service import resubmit
