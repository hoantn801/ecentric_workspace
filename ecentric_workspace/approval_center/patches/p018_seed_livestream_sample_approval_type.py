...
"""p018_seed_livestream_sample_approval_type: seed the single EC Approval Type row for
LIVESTREAM_SAMPLE that was added to approval_types_seed.json after p002 had already run
...
def execute():
    ...
    frappe.db.commit()
    frappe.logger("approval_center").info("p018_seed_livestream_sample_approval_type: created %s (Coming Soon)" % CODE)
