...
def _html():
    ...
    with open(os.path.join(base, "frontend", "purchase_request.main_section.html"), encoding="utf-8") as fh:
        return fh.read()
...
BASELINE_SHA256 = "482e9c6c5990d41302f03113cfc797b8fe3f1ec694800111329e9bda06098615"
SUPERSEDES_SHA256 = ()
