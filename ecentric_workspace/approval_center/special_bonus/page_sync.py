...
def _html():
    ...
    with open(os.path.join(base, "frontend", "special_bonus.main_section.html"), encoding="utf-8") as fh:
        return fh.read()
...
BASELINE_SHA256 = "eac35dc70d150b1733051d034dcb1192a2c106eaff9e9ce8ab595ac3219ccde8"
SUPERSEDES_SHA256 = ()
