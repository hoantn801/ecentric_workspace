...
from ecentric_workspace.approval_center.payment_request.service import normalize_payment, payment_title, validate_payment
...
PAYMENT_REQUEST_DEFINITION = _make(
    ...
    ("reason", "payment_amount", "payment_date", "payee_full_name", "account_bank",
