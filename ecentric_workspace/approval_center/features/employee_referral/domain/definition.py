...
def _submit(name):
    from ecentric_workspace.approval_center.features.employee_referral.application.service import submit
    return submit(name)


def _resubmit(name, actor=None):
    from ecentric_workspace.approval_center.features.employee_referral.application.service import resubmit
