...
"""Idempotent Employee Referral Web Page sync. Delegates to the shared ORM-only upsert
...
ROUTE = "approvals/employee-referral"
...
BASELINE_SHA256 = "2aa585b61113d6902a2a09db7a35c32b14d1257dc28baab30b8f8420ab41cd0f"
SUPERSEDES_SHA256 = (
    "0154d48b6e6837768d77c2334fe10c88d2f040342910f811a629d9fe7e951707",  # ban dang chay tren main truoc dot nay (cap Bo qua hien ten nguoi duyet)
    "6a6a3dc1bcd0357ab0784ace5e18b92d111973d47f5bc25df1c8cc41f723e9e6",  # superseded by 0154d48b6e68 (upload permission fix)
    "e07d0f795a13d398a6965eb86dd0d0730c692460a695a2f3bc1b0a403df46591",  # superseded by 6a6a3dc1bcd0 (upload errors + brand list + layout)
    "e7a177495d6f21657008c30a830ce5a9eabb171272ac6bbb88016f0b027592d3",  # superseded by e07d0f795a13 (upload UX + tick)
    "95c2e0f33239c902e38bcc43ced0509a7240ff0ee5de42af8ea8778942fd4e40",  # superseded by e7a177495d6f (nhớ tab khi quay lại hub)
    "fdb33a4ecdbcca6c1fe41983391134883ca89df7281af8d4a345f8f01e110e79",  # superseded by the hub edit (bỏ 3 tab + upload nhiều tệp)
    "369255dbad64ef85602bb289e60212f3e5cbf0973e01524806a55b55a16d6b3f",
)
...
def sync_employee_referral_page():
    if "System Manager" not in frappe.get_roles(frappe.session.user):
        frappe.throw(_("Only System Manager may sync the Employee Referral page."), frappe.PermissionError)
    return sync()
