...
def _title(doc):
    from ecentric_workspace.approval_center.features.late_early_out.application.service import gen_title
    return gen_title(doc)


def _submit(name):
    from ecentric_workspace.approval_center.features.late_early_out.application.service import submit
    return submit(name)


def _resubmit(name, actor=None):
    from ecentric_workspace.approval_center.features.late_early_out.application.service import resubmit
