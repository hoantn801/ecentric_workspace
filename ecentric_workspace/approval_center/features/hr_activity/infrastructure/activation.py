...
from ecentric_workspace.approval_center.features.hr_activity.infrastructure.setup import validate_hr_activity_v1
...
@frappe.whitelist()
def enable_hr_activity_uat(dry_run=1, apply=0, commit=0):
...
@frappe.whitelist()
def publish_hr_activity_after_uat(dry_run=1, apply=0, commit=0):
