...
from ecentric_workspace.approval_center.features.leave.infrastructure.setup import validate_leave_v1
...
@frappe.whitelist()
def enable_leave_uat(dry_run=1, apply=0, commit=0):
...
@frappe.whitelist()
def publish_leave_after_uat(dry_run=1, apply=0, commit=0):
