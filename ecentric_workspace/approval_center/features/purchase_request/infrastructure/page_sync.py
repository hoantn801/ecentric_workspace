...
"""Idempotent Purchase Request Web Page sync. Delegates to the shared ORM-only upsert
...
BASELINE_SHA256 = "411c50c60af4309613e0a96c26a92ce000761ad95a23f79aae4b665d4099fa48"
SUPERSEDES_SHA256 = (
    "d8f12eb48f9ba1eebeadf9d4075283b77dac10fe08c38d117771b23ef760cb23",  # DANG CHAY TREN LIVE truoc dot 16/09 (p200 da ghi)
    "fceb6ec7e7dc817cc179410c20414e6b891d6afc17e52e2e30cc8972fbb2925c",  # BASELINE cu (p200 doi HTML ma quen bump - cong do san tren main)
    "c00e840cc526b25c3e034a46eba4a0ec6c079489fe18fbe5336d1e57bc60d845",  # ban dang chay tren main truoc dot nay (cap Bo qua hien ten nguoi duyet)
    "8f14069148fbd33b3f7953a056f05dec54eece619e77171e865d9f81bb46d50b",  # superseded by c00e840cc526 (upload permission fix)
    "ecf31fff34b3608bac55184ff44fca201c617ab5149873c2fa4875c24ed2b2a8",  # superseded by 8f14069148fb (upload errors + brand list + layout)
    "6973b9c3a8c5516e82391831071334b09e8d1bfe8abed5da10dad160e68a7e57",  # superseded by ecf31fff34b3 (upload UX + tick)
    "a283836561ddca51b6fade7d9f7627c9020367fd256eb558915e62b3afdb0f17",  # superseded by 6973b9c3a8c5 (nhớ tab khi quay lại hub)
    "0974f730097147960c0a362e89f15a7a3e7b8ac8ac360a7bcd58b9d42034d6e1",  # superseded by the hub edit (bỏ 3 tab + upload nhiều tệp)
    "482e9c6c5990d41302f03113cfc797b8fe3f1ec694800111329e9bda06098615",
)
...
def sync_purchase_request_page():
    if "System Manager" not in frappe.get_roles(frappe.session.user):
        frappe.throw(_("Only System Manager may sync the Purchase Request page."), frappe.PermissionError)
    return sync()
