...
from ecentric_workspace.approval_center.features.outside_work.infrastructure.setup import validate_outside_work_v1
...
@frappe.whitelist()
def enable_outside_work_uat(dry_run=1, apply=0, commit=0):
...
@frappe.whitelist()
def publish_outside_work_after_uat(dry_run=1, apply=0, commit=0):
