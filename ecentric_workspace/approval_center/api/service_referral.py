...
"""Permission-safe read + write API for Service referral (Batch 7). Fixed-participant
...
_EDITABLE_DRAFT = ("client", "brand", "contact_name", "contact_phone_number", "contact_email", "estimated_contract_value", "justification", "request_attachment", "department", "company")
...
_LIST_COLS = ['client', 'brand', 'estimated_contract_value']
...
def save_draft(name=None, payload=None):
    ...
    from ecentric_workspace.approval_center.service_referral import service as _svc
...
def submit_request(name):
    from ecentric_workspace.approval_center.service_referral import service as svc
