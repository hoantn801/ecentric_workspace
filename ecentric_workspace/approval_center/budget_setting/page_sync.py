...
def _html():
    ...
    with open(os.path.join(base, "frontend", "budget_setting.main_section.html"), encoding="utf-8") as fh:
        return fh.read()
...
BASELINE_SHA256 = "8bdc823274a16dcf7e9db3b7d2673cbc52b358f9b4633af86fc15a3da0d92079"
SUPERSEDES_SHA256 = ()
