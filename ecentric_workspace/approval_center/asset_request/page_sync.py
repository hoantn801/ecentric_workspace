...
"""Versioned, idempotent Asset Request Web Page sync. The page patch creates the
...
NAME = "approval-center-asset-request"
TITLE = "Asset Request"
...
def sync(html=None):
    ...
    frappe.logger("approval_center").info("asset_request page_sync: %s Web Page /%s" % (action, ROUTE))
