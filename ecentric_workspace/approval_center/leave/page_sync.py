...
def _html():
    ...
    with open(os.path.join(base, "frontend", "leave.main_section.html"), encoding="utf-8") as fh:
        return fh.read()
...
BASELINE_SHA256 = "2dfbf7906db77eb8f39d6d40bc4bbe992b670248310366c9f4ca72131cc08d33"
SUPERSEDES_SHA256 = ()
