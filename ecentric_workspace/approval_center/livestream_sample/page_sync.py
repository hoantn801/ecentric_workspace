...
def _html():
    ...
    with open(os.path.join(base, "frontend", "livestream_sample.main_section.html"), encoding="utf-8") as fh:
        return fh.read()
...
BASELINE_SHA256 = "fec7a29cc69daca86b2836b7a0e4c2a23122aa2e55eeee0d9d8f4808d9c5ba60"
SUPERSEDES_SHA256 = ()
