...
def _submit(name):
    from ecentric_workspace.approval_center.livestream_sample.service import submit
    return submit(name)


def _resubmit(name, actor=None):
    from ecentric_workspace.approval_center.livestream_sample.service import resubmit
