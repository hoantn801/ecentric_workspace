...
def _html():
    ...
    with open(os.path.join(base, "frontend", "employee_referral.main_section.html"), encoding="utf-8") as fh:
        return fh.read()
...
BASELINE_SHA256 = "369255dbad64ef85602bb289e60212f3e5cbf0973e01524806a55b55a16d6b3f"
SUPERSEDES_SHA256 = ()
