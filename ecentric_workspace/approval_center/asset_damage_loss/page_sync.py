...
def _html():
    ...
    with open(os.path.join(base, "frontend", "asset_damage_loss.main_section.html"), encoding="utf-8") as fh:
        return fh.read()
...
BASELINE_SHA256 = "805290ddd78ba478e7d9a5fcf7baee7ddd8bcd38b9f88cb2dc6ecf5c5267f9a4"
SUPERSEDES_SHA256 = ()
