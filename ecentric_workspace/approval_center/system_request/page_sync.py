...
"""Versioned, idempotent System Request Web Page sync. The page patch creates the
...
NAME = "approval-center-system-request"
...
def sync(html=None):
    ...
    frappe.logger("approval_center").info("system_request page_sync: %s Web Page /%s" % (action, ROUTE))
