...
def _html():
    ...
    with open(os.path.join(base, "frontend", "hiring_request.main_section.html"), encoding="utf-8") as fh:
        return fh.read()
...
BASELINE_SHA256 = "e527395908a88cef99b103c00f16f518cd14a35b980fcc4bcf59664899202f49"
SUPERSEDES_SHA256 = ()
