...
def _html():
    ...
    with open(os.path.join(base, "daily_target", "ui", "main_section.html"), encoding="utf-8") as fh:
        return fh.read()
...
BASELINE_SHA256 = "f8d855cf495fc673357c9faa153be49b3f29635b47aa99cc7837c05c5a38f891"
SUPERSEDES_SHA256 = ()
