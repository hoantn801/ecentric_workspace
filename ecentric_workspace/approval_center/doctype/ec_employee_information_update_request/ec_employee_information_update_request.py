...
"""EC Employee Information Update Request - business data only. Approval STATE lives on EC Approval Request.
...
class ECEmployeeInformationUpdateRequest(Document):
    def validate(self):
