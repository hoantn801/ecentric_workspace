...
def _html():
    ...
    with open(os.path.join(base, "frontend", "promotion.main_section.html"), encoding="utf-8") as fh:
        return fh.read()
...
BASELINE_SHA256 = "b94efce3165c9a90bf8b1d5d53dddfcbff415a20786146a6863a2a125ab8184c"
SUPERSEDES_SHA256 = ()
