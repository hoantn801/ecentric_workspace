...
class _Doc:
    def __init__(self, doctype, name, fields, values):
        ...
        self.meta = types.SimpleNamespace(
            fields=[types.SimpleNamespace(fieldname=f, fieldtype=t) for f, t in fields])
        self._v = values
...
class TestClaimUploadedFiles(unittest.TestCase):
    ...
    def test_noop_when_already_attached(self):
        calls = self._stub(True, "FILE-1")
