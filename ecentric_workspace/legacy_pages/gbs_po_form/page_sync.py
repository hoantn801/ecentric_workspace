...
"""Idempotent sync for the LEGACY /gbs-po-form Web Page (document page).
...
def sync_gbs_po_form_page():
    if "System Manager" not in frappe.get_roles(frappe.session.user):
        frappe.throw(_("Only System Manager may sync the /gbs-po-form page."), frappe.PermissionError)
    return sync()
