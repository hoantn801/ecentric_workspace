...
"""Idempotent sync for the LEGACY /mso-form Web Page (legacy creation form).
...
def sync_mso_form_page():
    if "System Manager" not in frappe.get_roles(frappe.session.user):
        frappe.throw(_("Only System Manager may sync the /mso-form page."), frappe.PermissionError)
    return sync()
