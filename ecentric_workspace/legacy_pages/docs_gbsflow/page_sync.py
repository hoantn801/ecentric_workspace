...
"""Idempotent sync for the LEGACY /docs/gbs-flow Web Page (document page).
...
ROUTE = "docs/gbs-flow"
NAME = "gbs-flow-definitions"
TITLE = "GBS Flow & Definitions"
...
def sync_docs_gbsflow_page():
    if "System Manager" not in frappe.get_roles(frappe.session.user):
        frappe.throw(_("Only System Manager may sync the /docs/gbs-flow page."), frappe.PermissionError)
    return sync()
